...
function navigateTo(page) {
    ...
    switch (page) {
        case 'adminPersonalDetails':
            window.location.href = 'admin_personal_details.html';
            break;
        case 'patients':
            window.location.href = 'PatientsListForAdminWithPwd.html';
            break;
        case 'doctors':
            window.location.href = 'DoctorsListForAdminWithPwd.html';
            break;
