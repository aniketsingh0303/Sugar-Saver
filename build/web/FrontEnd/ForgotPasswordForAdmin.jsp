...
<%
    String user = request.getParameter("aUsr");
    String newpwd = request.getParameter("naPwd");
    String connewpwd = request.getParameter("caPwd");
    ...
    try {
        ...
        ps1 = conn.prepareStatement("UPDATE AdminLogin SET UPASSWORD = ? WHERE USERNAME = ?");
