...
function hideAllContainers() {
    const containers = ['patientLogin', 'doctorLogin', 'adminLogin', 'patientSignup', 'doctorSignup', 'forgotPasswordPatient','forgotPasswordDoctor','forgotPasswordAdmin'];
...
function forgotPassPatient(userType) {
    consumer = userType;
    hideAllContainers();
    document.getElementById('forgotPasswordPatient').style.display = 'block';
}

function forgotPassDoctor(userType) {
    consumer = userType;
    hideAllContainers();
    document.getElementById('forgotPasswordDoctor').style.display = 'block';
}

function forgotPassAdmin(userType) {
    consumer = userType;
    hideAllContainers();
    document.getElementById('forgotPasswordAdmin').style.display = 'block';
}

function handleForgetPasswordPatient(userType) {
    const username = document.getElementById('forgetPasswordPatientForm').getElementsByTagName('input')[0].value;
    const password = document.getElementById('forgetPasswordPatientForm').getElementsByTagName('input')[1].value;
    const c_password = document.getElementById('forgetPasswordPatientForm').getElementsByTagName('input')[2].value;
    console.log("Forget Password for:", consumer);
    console.log(username, password, c_password);
}

function handleForgetPasswordDoctor(userType) {
    const username = document.getElementById('forgetPasswordDoctorForm').getElementsByTagName('input')[0].value;
    const password = document.getElementById('forgetPasswordDoctorForm').getElementsByTagName('input')[1].value;
    const c_password = document.getElementById('forgetPasswordDoctorForm').getElementsByTagName('input')[2].value;
    console.log("Forget Password for:", consumer);
    console.log(username, password, c_password);
}

function handleForgetPasswordAdmin(userType) {
    const username = document.getElementById('forgetPasswordAdminForm').getElementsByTagName('input')[0].value;
    const password = document.getElementById('forgetPasswordAdminForm').getElementsByTagName('input')[1].value;
    const c_password = document.getElementById('forgetPasswordAdminForm').getElementsByTagName('input')[2].value;
    console.log("Forget Password for:", consumer);
    console.log(username, password, c_password);
}
